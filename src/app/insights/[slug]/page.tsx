      ...
      <div className="pt-28 pb-20 px-6 sm:px-8 lg:px-12 max-w-4xl mx-auto space-y-12">
        ...
        <article className="p-8 sm:p-12 rounded-3xl bg-[#15171E] border border-white/10 shadow-2xl space-y-8">
          ...
          <div className="space-y-6 text-gray-300 text-sm sm:text-base font-light leading-relaxed">
            <p>
              Architecting scalable software applications requires strict enforcement of decoupling, predictable state flows, and modular data contracts.
            </p>
            ...
            <p>
              In our production architecture, we divide mobile codebases into three discrete layers: Presentation (BLoC/Cubit), Domain (Entities & Use Cases), and Data (Dio API & Hive Local Storage).
            </p>
...
class GetUserProfileUseCase {
  ...
  Future<Either<Failure, UserEntity>> call(String id) async {
    return await repository.getUserProfile(id);
            ...
            <p>
              By keeping the domain layer 100% free of Flutter UI dependencies, unit testing business logic requires zero widget pump overhead.
            </p>
          </div>
          ...
          <div className="pt-8 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs font-mono text-gray-400">Full-Stack Mobile Developer & Flutter Lead</p>
              </div>
            </div>
