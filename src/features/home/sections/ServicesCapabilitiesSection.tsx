...
export const ServicesCapabilitiesSection = () => {
  ...
  return (
    <section id="capabilities" className="py-10 sm:py-16 md:py-20 lg:py-24 px-4 sm:px-8 lg:px-12 max-w-7xl mx-auto border-b border-white/[0.06]">
      {/* Section Header */}
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-8 sm:mb-12">
        ...
        <Link
          href="/work"
          className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full border border-white/10 hover:border-[#E58A2B] bg-[#15171E] text-gray-300 hover:text-[#E58A2B] font-mono text-xs font-semibold transition-all duration-300 self-start md:self-auto hover:shadow-[0_0_20px_rgba(229,138,43,0.2)] shrink-0"
        >
          ...
          return (
            ...
            >
              <TiltCard className="h-full">
                <div className="relative p-5 sm:p-6 rounded-2xl sm:rounded-3xl bg-[#15171E]/90 border border-white/10 hover:border-[#E58A2B]/60 transition-all duration-500 flex flex-col justify-between h-full group shadow-2xl space-y-4 hover:-translate-y-1 hover:shadow-[0_0_30px_rgba(229,138,43,0.18)] backdrop-blur-xl overflow-hidden">
                  
                  {/* Card Header & Stat Badge */}
                  <div className="space-y-3.5">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        <div className="p-2.5 sm:p-3 rounded-xl sm:rounded-2xl bg-[#E58A2B]/10 border border-[#E58A2B]/20 text-[#E58A2B] group-hover:bg-[#E58A2B] group-hover:text-black transition-all duration-300 group-hover:scale-105">
                        ...
                        <div>
                          ...
                          <h3 className="font-display text-lg sm:text-xl font-bold text-white group-hover:text-[#E58A2B] transition-colors mt-0.5">
                            {item.title}
                          </h3>
                        </div>
                      </div>
                    ...
                    <div className="pt-0.5 space-y-1.5">
                      <span className="font-mono text-[10px] sm:text-[11px] font-bold text-[#E58A2B] uppercase tracking-wider block">
                  ...
                  <div className="pt-3 border-t border-white/10 flex flex-wrap gap-1.5">
                    {item.tags.map((tag, tIdx) => (
                      <span
                        key={tIdx}
                        className="px-2.5 py-0.5 rounded-full bg-white/5 border border-white/10 font-mono text-[10px] sm:text-[11px] text-gray-300 group-hover:border-[#E58A2B]/30 group-hover:text-white transition-colors"
                      >
                        {tag}
                      </span>
                    ))}
