...
export const ExperienceSection = () => {
  return (
    <section id="experience" className="py-24 md:py-32 px-6 sm:px-8 lg:px-12 max-w-7xl mx-auto border-b border-white/[0.06]">
      ...
      {/* Alternating Centered Timeline Wrapper */}
      <div className="relative">
        {/* Central Vertical Glowing Line (Visible on Desktop) */}
        ...
        <div className="space-y-16">
          {experiences.map((exp, idx) => {
            ...
            const isEven = idx % 2 === 0; // Even items on left, Odd on right for desktop
              ...
              >
                ...
                <div className="w-full md:w-1/2 pl-12 md:pl-0 md:px-8">
                  <TiltCard className="h-full">
                    <div className="p-7 sm:p-9 rounded-3xl bg-[#15171E] border border-white/10 group-hover:border-[#E58A2B]/60 transition-all duration-500 shadow-2xl space-y-6">
                      {/* Card Header */}
                      ...
                      <div className="space-y-2.5">
                        {exp.descriptionPoints.map((pt, pIdx) => (
                          <div
                            key={pIdx}
                            className="p-3.5 rounded-xl bg-white/5 border border-white/5 flex items-start gap-3 hover:border-[#E58A2B]/30 transition-colors"
                          >
                ...
                {/* Empty Half Column for Desktop Balance */}
