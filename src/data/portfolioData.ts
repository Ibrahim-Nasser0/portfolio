...
export const skillCategories: SkillCategoryModel[] = [
  {
    title: "Languages",
    iconName: "Code",
    skills: ["Dart", "C#", "C++", "Python", "SQL", "TypeScript", "JavaScript"],
  },
  {
    title: "Mobile & Cross-Platform",
    iconName: "Smartphone",
    skills: ["Flutter (Mobile & Desktop)", "BLoC", "Cubit", "Provider", "Dio", "get_it", "React / Next.js"],
  },
  {
    title: "Architecture & Design Patterns",
    iconName: "Layers",
    skills: ["Clean Architecture", "MVVM", "MVC", "Repository Pattern", "SOLID Principles", "OOP"],
  },
  {
    title: "API & Networking",
    iconName: "Globe",
    skills: ["RESTful APIs", "Dio Library", "Error Handling", "API Service Layer", "Image Caching"],
  },
  {
    title: "Databases & Storage",
    iconName: "Database",
    skills: ["MS SQL Server", "SQLite (sqflite)", "Shared Preferences", "MongoDB"],
  },
  {
    title: "Tools & Platforms",
    iconName: "Wrench",
    skills: ["Git", "GitHub", "Postman", "Android Studio", "VS Code", "Figma", "Trello"],
  },
];
